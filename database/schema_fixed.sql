-- Askiaverse Database Schema - Fixed Version
-- Execute this SQL to create the required tables in proper order
...
-- Themes table (depends on subjects)
...
-- Questions table (depends on themes)
...
-- Quiz attempts table (depends on users, subjects, themes)
...
-- User progress table (depends on users, subjects, themes)
...
-- User achievements table (depends on users, achievements)
