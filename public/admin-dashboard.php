...
<body class="bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="/subjects.php" class="bg-blue-600 text-white p-6 rounded-xl shadow-lg hover:bg-blue-700 transition-colors duration-200 text-center">
                <div class="text-3xl mb-2">📚</div>
                <h3 class="text-xl font-bold mb-2">Voir les Matières</h3>
                <p class="text-blue-100">Explorer le contenu éducatif</p>
            </a>
            
            <a href="/subject.php?id=1" class="bg-green-600 text-white p-6 rounded-xl shadow-lg hover:bg-green-700 transition-colors duration-200 text-center">
                <div class="text-3xl mb-2">🔢</div>
                <h3 class="text-xl font-bold mb-2">Mathématiques</h3>
                <p class="text-green-100">Voir les thèmes et questions</p>
            </a>
            
            <a href="/" class="bg-purple-600 text-white p-6 rounded-xl shadow-lg hover:bg-purple-700 transition-colors duration-200 text-center">
                <div class="text-3xl mb-2">🏠</div>
